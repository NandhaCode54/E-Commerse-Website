...
/**
 * A one-time email-verification token. Only the SHA-256 hash of the raw token is
...
@Table(name = "email_verification_tokens", uniqueConstraints = {
        @UniqueConstraint(name = "uq_email_verification_tokens_hash", columnNames = {"token_hash"})
}, indexes = {
